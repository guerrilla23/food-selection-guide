...
PHASE_C_FOODS = {
    ...
    'natto': {
        ...
        'ok': {
            ...
            'bleeds': [(0, 10, 105, 75, '#A07848')],
            'leaves': [],
            'body_paths': [
                # Pile of beans (multiple ovals)
                # Bottom row
                'M -75 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M -40 55 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M -5 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 30 55 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 65 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                # Middle row
                'M -55 20 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M -22 25 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 12 20 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 45 25 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                # Upper row
                'M -35 -10 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M -3 -5 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 28 -10 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                # Top
                'M -15 -35 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
                'M 15 -35 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0 Z',
            ],
            'ink': [
                # Outline several beans (sample)
                ('M -75 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -40 55 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -5 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 30 55 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 65 50 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -55 20 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -22 25 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 12 20 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 45 25 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -35 -10 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -3 -5 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 28 -10 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -15 -35 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 15 -35 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                # Sticky strings (糸)
                ('M -30 -50 Q -10 -65 10 -55 Q 30 -45 50 -55', 0.7, 1.4),
                ('M 0 -55 Q 25 -75 45 -68', 0.6, 1.3),
            ],
        },
        'ng': {
            'body_color': '#988050',
            ...
            'imperfections': [
                # No threads (or few)
                {'kind': 'ellipse', 'cx': -50, 'cy': 0, 'rx': 22, 'ry': 12, 'fill': '#3D3018', 'opacity': 0.6},
                {'kind': 'ellipse', 'cx': 30, 'cy': -10, 'rx': 18, 'ry': 10, 'fill': '#3D3018', 'opacity': 0.55},
            ],
        },
