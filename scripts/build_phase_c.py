...
PHASE_C_FOODS = {
    ...
    # 2. natto — natural pile of beans with prominent sticky strings
    'natto': {
        'id': 'natto', 'name': '納豆',
        'theme_color': '#A07848',
        'season_text': '通年',
        ...
        'ok': {
            ...
            'body_paths': [
                ...
                'M 80 60 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                # 中段
                ...
                'M 55 32 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                # 上段
                'M -50 5 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                'M -22 8 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0 Z',
                'M 8 5 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                'M 38 8 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                # 上中
                'M -30 -22 m -12 0 a 12 9 0 1 0 24 0 a 12 9 0 1 0 -24 0 Z',
                'M 0 -25 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0 Z',
                'M 28 -20 m -12 0 a 12 9 0 1 0 24 0 a 12 9 0 1 0 -24 0 Z',
                # 頂上
                'M -8 -50 m -11 0 a 11 9 0 1 0 22 0 a 11 9 0 1 0 -22 0 Z',
                'M 18 -48 m -11 0 a 11 9 0 1 0 22 0 a 11 9 0 1 0 -22 0 Z',
            ],
            'ink': [
                # 全粒の輪郭
                ('M -82 65 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M -52 70 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M -18 67 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M 18 70 m -15 0 a 15 12 0 1 0 30 0 a 15 12 0 1 0 -30 0',),
                ('M 52 65 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M 80 60 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M -68 35 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M -38 38 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M -8 35 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M 22 38 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M 55 32 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M -50 5 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M -22 8 m -14 0 a 14 11 0 1 0 28 0 a 14 11 0 1 0 -28 0',),
                ('M 8 5 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M 38 8 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M -30 -22 m -12 0 a 12 9 0 1 0 24 0 a 12 9 0 1 0 -24 0',),
                ('M 0 -25 m -13 0 a 13 10 0 1 0 26 0 a 13 10 0 1 0 -26 0',),
                ('M 28 -20 m -12 0 a 12 9 0 1 0 24 0 a 12 9 0 1 0 -24 0',),
                ('M -8 -50 m -11 0 a 11 9 0 1 0 22 0 a 11 9 0 1 0 -22 0',),
                ('M 18 -48 m -11 0 a 11 9 0 1 0 22 0 a 11 9 0 1 0 -22 0',),
                # 糸引き (粘りの細い線、多数)
                # 上空に伸びる長い糸
                ('M -10 -55 Q -25 -85 -50 -100', 0.55, 1.2),
                ('M 5 -55 Q 0 -90 15 -110', 0.55, 1.2),
                ('M 20 -50 Q 45 -75 70 -90', 0.55, 1.2),
                # 粒間の短い糸 (各層に分散)
                ('M -65 -10 Q -45 -30 -25 -22', 0.5, 1),
                ('M 5 -25 Q 25 -38 35 -22', 0.5, 1),
                ('M -22 8 Q -12 -10 5 5', 0.45, 1),
                ('M 8 5 Q 22 -8 38 8', 0.45, 1),
                ('M -38 38 Q -22 25 -8 35', 0.45, 1),
                ('M 22 38 Q 38 25 55 32', 0.45, 1),
                ('M -52 70 Q -38 55 -18 67', 0.45, 1),
                ('M 18 70 Q 35 55 52 65', 0.45, 1),
                # 横断する長い糸
                ('M -82 60 Q 0 30 80 55', 0.4, 1.1),
            ],
        },
        'ng': {
            'body_color': '#988050',
