...
FOODS = {
    ...
    # 8. banana — single curved banana with green stem
    'banana': {
        'id': 'banana',
        'name': 'バナナ',
        'theme_color': '#E0B040',
        'season_text': '通年',
        'viewbox': '-140 -130 280 220',
        'ok': {
            'seed': 37,
            ...
            'ink': [
                ...
                # 先端 (黒チップ)
                ('M 115 -25 L 122 -10 L 117 -2', 0.85, 2.2),
            ],
        },
        'ng': {
            'body_color': '#988030',
            'leaf_color': '#3D2817',
            'body_paths': [
                'M -95 -65 Q -50 -100 50 -85 Q 105 -65 120 -15 Q 110 25 75 30 Q 0 15 -55 25 Q -90 25 -110 0 Q -120 -35 -95 -65 Z',
            ],
            'leaves': [
                'M -100 -55 Q -110 -85 -90 -100 Q -78 -95 -85 -65 Z',
            ],
            'imperfections': [
                # 大きな黒い斑点 (シュガースポット過剰)
                {'kind': 'ellipse', 'cx': -40, 'cy': -50, 'rx': 25, 'ry': 18, 'fill': '#3D2817', 'opacity': 0.7},
                {'kind': 'ellipse', 'cx': 30, 'cy': -20, 'rx': 30, 'ry': 22, 'fill': '#3D2817', 'opacity': 0.7},
                {'kind': 'ellipse', 'cx': 80, 'cy': 5, 'rx': 18, 'ry': 14, 'fill': '#3D2817', 'opacity': 0.65},
            ],
        },
